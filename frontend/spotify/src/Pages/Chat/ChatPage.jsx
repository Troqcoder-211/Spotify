...
const NoConversationPlaceholder = () => (
  <div className="flex flex-col items-center justify-center h-full space-y-6">
    <img src={assets.spotify_logo} alt="Spotify" className="size-16 animate-bounce" />
    <div className="text-center">
      <h3 className="text-zinc-300 text-lg font-medium mb-1">Chưa chọn cuộc hội thoại</h3>
      <p className="text-zinc-500 text-sm">Chọn một người bạn để bắt đầu trò chuyện</p>
    </div>
  </div>
);
