	...
	return (
		...
		>
			<div className='bg-gray-900 text-white p-8 rounded-lg shadow-lg w-96'>
				...
				<button className=' cursor-pointer w-full bg-green-500 text-black font-semibold py-2 rounded-full mb-4 border-2 border-transparent hover:border-white'>
					Đăng nhập với Facebook
				</button>
				<button className='cursor-pointer w-full bg-gray-800 text-white font-semibold py-2 rounded-full mb-4 border-2 border-gray-600 hover:border-white'>
