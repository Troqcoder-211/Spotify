...
DATABASES = {
    ...
    'default': {
        'ENGINE': 'django.db.backends.mysql',  # Sử dụng MySQL
        'NAME': os.getenv('DB_NAME'),  # Thay bằng tên database của bạn
        'USER': os.getenv('DB_USER'),  # Tài khoản MySQL
        'PASSWORD': os.getenv('DB_PASSWORD'),  # Mật khẩu MySQL
        'HOST': os.getenv('DB_HOST'),  # Nếu dùng máy chủ từ xa, thay bằng IP
        'PORT': os.getenv('DB_PORT'),  # Cổng của P
        'OPTIONS': {
            'charset': 'utf8mb4',  # Hỗ trợ Unicode đầy đủ
        },
    }
